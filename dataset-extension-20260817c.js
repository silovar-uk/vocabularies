(() => {
  ...
  const extraDataset = "data/research-20260817-cognitive-dimensions-interface.json";
  ...
  window.fetch = async (...args) => {
    ...
    try {
      ...
      console.warn("August 17 cognitive-dimensions vocabulary extension failed:", error);
      return response;
    }
  };
})();
